...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        rnn = GRU(units, activation = 'relu', return_sequences = True, implementation = 2, name = 'rnn_%d' % i)(deep_rnn)
        deep_rnn = BatchNormalization()(rnn)
...
def final_model(input_dim, filters, kernel_size, conv_stride, conv_border_mode, units, recur_layers, 
                drop_rate = 0.1, output_dim=29):
    ...
    layer = BatchNormalization(name='bn_conv_1d')(conv_1d)
    for i in range(recur_layers):
        layer = GRU(units, activation = 'relu', return_sequences = True, implementation = 2, name = 'rnn_layer_%d' % i)(layer)
